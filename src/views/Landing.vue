<template>
  <v-container>
    <div class="fullViewportHeight">
      <v-layout column fill-height>
        <v-flex xs5>
          <div class="text-xs-center">
            <img width="15%" src="../assets/turbologo.png">
            <header class="text-xs-center display-3 font-weight-bold">
              TurboDoto
            </header>
            <div class="text-xs-center headline">The Tracker for Turbo</div>
          </div>
        </v-flex>
        <v-flex xs3 justify-end class="justify-end">
            <searchbox v-on:userdata="user1data = $event"></searchbox>
        </v-flex>
        <v-flex xs4>
          <div class="text-xs-center headline">Enter your <strong>SteamID</strong> above to get started.</div>
        </v-flex>
      </v-layout>
    </div>

    <v-layout row>
      <v-flex xs12 class="pa-2 mr-2">
